...
export default function SignUpPage() {
  return (
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-between border-r-2 border-retro-black bg-retro-black p-4 text-white sm:p-6 md:p-12 lg:p-16">
        <div className="mb-12">
        ...
        <div className="max-w-md">
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border border-retro-blue bg-retro-blue/10 text-retro-blue sm:h-10 sm:w-10">
            ...
            <div className="flex gap-4">
              <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border border-retro-red bg-retro-red/10 text-retro-red sm:h-10 sm:w-10">
            ...
            <div className="flex gap-4">
              <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border border-retro-peach bg-retro-peach/10 text-retro-peach sm:h-10 sm:w-10">
