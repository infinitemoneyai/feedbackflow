"use strict";var FeedbackFlow=(()=>{var F=Object.defineProperty;var ce=Object.getOwnPropertyDescriptor;var le=Object.getOwnPropertyNames;var de=Object.prototype.hasOwnProperty;var pe=(n,e)=>{for(var t in e)F(n,t,{get:e[t],enumerable:!0})},he=(n,e,t,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let o of le(e))!de.call(n,o)&&o!==t&&F(n,o,{get:()=>e[o],enumerable:!(i=ce(e,o))||i.enumerable});return n};var fe=n=>he(F({},"__esModule",{value:!0}),n);var Ee={};pe(Ee,{FeedbackFlow:()=>se,FeedbackFlowWidget:()=>v});var z={position:"bottom-right",primaryColor:"#1a1a1a",backgroundColor:"#F7F5F0",textColor:"#1a1a1a",buttonText:"Feedback",apiUrl:""};function ue(n){switch(n){case"bottom-right":return"bottom: 20px; right: 20px;";case"bottom-left":return"bottom: 20px; left: 20px;";case"top-right":return"top: 20px; right: 20px;";case"top-left":return"top: 20px; left: 20px;";default:return"bottom: 20px; right: 20px;"}}function me(n){let e=n.includes("bottom"),t=n.includes("right");return`
    .ff-button-container {
  ...
  `}function $(n){let e=ue(n.position),t=me(n.position);return`
  ...
  `}function r(n,e,t){let i=document.createElement(n);if(e)for(let[o,s]of Object.entries(e))o==="className"?i.className=s:i.setAttribute(o,s);if(t)for(let o of t)typeof o=="string"?i.appendChild(document.createTextNode(o)):i.appendChild(o);return i}function l(n){let e=document.createElement("template");return e.innerHTML=n.trim(),e.content.firstChild}function A(n,e){if(document.getElementById(e))return;let t=r("style",{id:e,type:"text/css"},[n]);document.head.appendChild(t)}function O(){let n=document.getElementById("ff-widget-root");if(n)return n;let e=r("div",{id:"ff-widget-root",className:"ff-widget-root"});return document.body.appendChild(e),e}var d={feedback:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    `,i=document.createElement("style");i.id=e,i.textContent=t,document.head.appendChild(i)}destroy(){this.annotationCanvas?.destroy(),this.annotationCanvas=null,this.container?.remove(),this.container=null,this.canvas=null,this.capturedImage=null}};var q=120*1e3,be=["video/webm;codecs=vp9,opus","video/webm;codecs=vp8,opus","video/webm;codecs=vp9","video/webm;codecs=vp8","video/webm","video/mp4"],y=class{constructor(e){this.mediaRecorder=null;this.screenStream=null;this.audioStream=null;this.combinedStream=null;this.chunks=[];this.startTime=0;this.timerInterval=null;this.mimeType="video/webm";this.callbacks=e}static isSupported(){return typeof navigator<"u"&&"mediaDevices"in navigator&&"getDisplayMedia"in navigator.mediaDevices&&typeof MediaRecorder<"u"}getSupportedMimeType(){for(let e of be)if(MediaRecorder.isTypeSupported(e))return e;return"video/webm"}async start(){if(this.mediaRecorder?.state==="recording")throw new Error("Recording already in progress");try{this.screenStream=await navigator.mediaDevices.getDisplayMedia({video:{displaySurface:"browser",cursor:"always"},audio:!1});try{this.audioStream=await navigator.mediaDevices.getUserMedia({audio:{echoCancellation:!0,noiseSuppression:!0,autoGainControl:!0},video:!1})}catch{c.log("Microphone not available, recording without audio")}let e=[...this.screenStream.getVideoTracks(),...this.audioStream?.getAudioTracks()||[]];this.combinedStream=new MediaStream(e),this.mimeType=this.getSupportedMimeType(),this.mediaRecorder=new MediaRecorder(this.combinedStream,{mimeType:this.mimeType,videoBitsPerSecond:25e5}),this.chunks=[],this.mediaRecorder.ondataavailable=t=>{t.data.size>0&&this.chunks.push(t.data)},this.mediaRecorder.onstop=()=>{this.handleStop()},this.mediaRecorder.onerror=t=>{let i=t,o=new Error(i.error?.message||"Recording failed");this.cleanup(),this.callbacks.onError(o)},this.screenStream.getVideoTracks()[0].onended=()=>{this.mediaRecorder?.state==="recording"&&this.stop()},this.mediaRecorder.start(1e3),this.startTime=Date.now(),this.callbacks.onStart(),this.startTimer()}catch(e){throw this.cleanup(),e}}stop(){this.mediaRecorder?.state==="recording"&&this.mediaRecorder.stop(),this.stopTimer()}handleStop(){let e=Date.now()-this.startTime,t=new Blob(this.chunks,{type:this.mimeType});this.cleanup(),this.callbacks.onStop({blob:t,duration:e,mimeType:this.mimeType})}startTimer(){this.timerInterval=setInterval(()=>{let e=Date.now()-this.startTime;this.callbacks.onTimeUpdate(e),e>=q&&this.stop()},100)}stopTimer(){this.timerInterval&&(clearInterval(this.timerInterval),this.timerInterval=null)}cleanup(){this.stopTimer(),this.screenStream?.getTracks().forEach(e=>e.stop()),this.audioStream?.getTracks().forEach(e=>e.stop()),this.combinedStream?.getTracks().forEach(e=>e.stop()),this.screenStream=null,this.audioStream=null,this.combinedStream=null,this.mediaRecorder=null,this.chunks=[]}isRecording(){return this.mediaRecorder?.state==="recording"}getElapsed(){return this.startTime?Date.now()-this.startTime:0}destroy(){this.stop(),this.cleanup()}};function S(n){let e=Math.floor(n/1e3),t=Math.floor(e/60),i=e%60;return`${t.toString().padStart(2,"0")}:${i.toString().padStart(2,"0")}`}function _(){return q}var T=class{constructor(e,t){this.recorder=null;this.recordingResult=null;this.state="idle";this.indicatorElement=null;this.previewElement=null;this.videoElement=null;this.timerElement=null;this.objectUrl=null;this.config=e,this.callbacks=t,this.injectStyles()}async start(){if(u()){this.showMobileUnsupportedMessage();return}if(!y.isSupported()||!k()){this.showUnsupportedMessage();return}try{this.state="recording",this.showRecordingIndicator(),this.recorder=new y({onStart:()=>{c.log("Recording started")},onStop:e=>{this.handleRecordingComplete(e)},onError:e=>{c.error("Recording error",e),this.hideRecordingIndicator(),this.callbacks.onCancel()},onTimeUpdate:e=>{this.updateTimer(e)}}),await this.recorder.start()}catch(e){c.error("Failed to start recording",e),this.hideRecordingIndicator(),this.callbacks.onCancel()}}showMobileUnsupportedMessage(){this.showMessageOverlay("Recording Not Available on Mobile","Screen recording requires a desktop browser. You can still take a screenshot to share feedback!",[{text:"Take Screenshot Instead",action:"screenshot",primary:!0},{text:"Cancel",action:"cancel",primary:!1}])}showUnsupportedMessage(){this.showMessageOverlay("Recording Not Supported","Your browser doesn't support screen recording. Try using Chrome, Edge, or Firefox on desktop.",[{text:"Take Screenshot Instead",action:"screenshot",primary:!0},{text:"Cancel",action:"cancel",primary:!1}])}showMessageOverlay(e,t,i){let o=r("div",{className:"ff-recording-preview-overlay"}),s=r("div",{className:"ff-recording-message-wrapper"}),a=r("div",{className:"ff-recording-message-content"},[r("div",{className:"ff-recording-message-icon"},[l(d.video)]),r("h3",{className:"ff-recording-message-title"},[e]),r("p",{className:"ff-recording-message-text"},[t])]),p=r("div",{className:"ff-recording-message-actions"});i.forEach(({text:h,action:f,primary:g})=>{let x=r("button",{className:`ff-recording-btn ff-btn-${g?"primary":"secondary"}`,type:"button"},[h]);x.addEventListener("click",()=>{if(o.remove(),f==="cancel")this.callbacks.onCancel();else if(f==="screenshot"){let ae=new CustomEvent("ff:switch-to-screenshot",{detail:{widgetKey:this.config.widgetKey}});window.dispatchEvent(ae),this.callbacks.onCancel()}}),p.appendChild(x)}),s.appendChild(a),s.appendChild(p),o.appendChild(s),document.body.appendChild(o)}showRecordingIndicator(){this.indicatorElement=r("div",{className:"ff-recording-indicator"});let e=r("div",{className:"ff-recording-content"},[r("div",{className:"ff-recording-dot"}),r("span",{className:"ff-recording-text"},["Recording"]),r("span",{className:"ff-recording-timer"},["00:00"]),r("span",{className:"ff-recording-separator"},[" / "]),r("span",{className:"ff-recording-max"},[S(_())])]),t=r("button",{className:"ff-recording-stop",type:"button"},[l(d.stop||d.close),"Stop"]);t.addEventListener("click",()=>this.stopRecording()),this.indicatorElement.appendChild(e),this.indicatorElement.appendChild(t),document.body.appendChild(this.indicatorElement),this.timerElement=this.indicatorElement.querySelector(".ff-recording-timer")}updateTimer(e){this.timerElement&&(this.timerElement.textContent=S(e))}hideRecordingIndicator(){this.indicatorElement?.remove(),this.indicatorElement=null,this.timerElement=null}stopRecording(){this.recorder?.stop()}handleRecordingComplete(e){this.recordingResult=e,this.state="preview",this.hideRecordingIndicator(),this.showPreview()}showPreview(){if(!this.recordingResult)return;this.objectUrl=URL.createObjectURL(this.recordingResult.blob),this.previewElement=r("div",{className:"ff-recording-preview-overlay"});let e=r("div",{className:"ff-recording-preview-wrapper"}),t=r("div",{className:"ff-recording-preview-header"},[r("h3",{className:"ff-recording-preview-title"},["Preview Recording"]),this.createCloseButton()]),i=r("div",{className:"ff-recording-preview-video-container"});this.videoElement=r("video",{className:"ff-recording-preview-video"}),this.videoElement.src=this.objectUrl,this.videoElement.controls=!0,this.videoElement.playsInline=!0,i.appendChild(this.videoElement);let o=r("div",{className:"ff-recording-preview-info"},[r("span",{className:"ff-recording-info-item"},[`Duration: ${S(this.recordingResult.duration)}`]),r("span",{className:"ff-recording-info-item"},[`Size: ${(this.recordingResult.blob.size/(1024*1024)).toFixed(2)} MB`])]),s=r("div",{className:"ff-recording-preview-actions"},[this.createButton("Retake","secondary",()=>this.retake()),this.createButton("Use Recording","primary",()=>this.confirm())]);e.appendChild(t),e.appendChild(i),e.appendChild(o),e.appendChild(s),this.previewElement.appendChild(e),document.body.appendChild(this.previewElement)}createCloseButton(){let e=r("button",{className:"ff-recording-preview-close",type:"button","aria-label":"Cancel"},[l(d.close)]);return e.addEventListener("click",()=>this.cancel()),e}createButton(e,t,i){let o=r("button",{className:`ff-recording-btn ff-btn-${t}`,type:"button"},[e]);return o.addEventListener("click",i),o}hidePreview(){this.previewElement?.remove(),this.previewElement=null,this.videoElement=null,this.objectUrl&&(URL.revokeObjectURL(this.objectUrl),this.objectUrl=null)}async retake(){this.hidePreview(),this.recordingResult=null,await this.start()}confirm(){if(!this.recordingResult)return;let e=this.recordingResult;this.hidePreview(),this.callbacks.onConfirm(e)}cancel(){this.recorder?.destroy(),this.hideRecordingIndicator(),this.hidePreview(),this.recordingResult=null,this.callbacks.onCancel()}injectStyles(){let e="ff-recording-styles";if(document.getElementById(e))return;let t=`
    ...
    `,i=document.createElement("style");i.id=e,i.textContent=t,document.head.appendChild(i)}destroy(){this.recorder?.destroy(),this.hideRecordingIndicator(),this.hidePreview(),this.recordingResult=null}};var Y="ff_submission_queue",ve=5,xe=1e3;function ye(){return`ff_${Date.now()}_${Math.random().toString(36).substring(2,9)}`}function we(n){let e=xe*Math.pow(2,n),t=e*.2*Math.random();return Date.now()+e+t}var w=class n{constructor(e=""){this.retryTimer=null;this.isProcessing=!1;this.apiUrl=e||this.getDefaultApiUrl(),this.setupConnectivityListener(),this.scheduleRetry()}getDefaultApiUrl(){if(typeof window>"u")return"";let e=document.querySelectorAll('script[src*="widget.js"]');for(let t of Array.from(e)){let i=t.src;if(i)try{return`${new URL(i).origin}/api/widget/submit`}catch{}}return"https://feedbackflow.cc/api/widget/submit"}setupConnectivityListener(){typeof window>"u"||window.addEventListener("online",()=>{c.log("Connection restored, processing queue..."),this.processQueue()})}getQueue(){try{let e=localStorage.getItem(Y);return e?JSON.parse(e):[]}catch{return[]}}saveQueue(e){try{localStorage.setItem(Y,JSON.stringify(e))}catch(t){c.error("Failed to save queue",t)}}addToQueue(e,t,i,o){let s=this.getQueue(),a={id:ye(),widgetKey:e,formData:t,screenshotDataUrl:i,recordingBlob:o?this.blobToBase64Sync(o):void 0,recordingMimeType:o?.type,timestamp:Date.now(),retryCount:0,nextRetryAt:Date.now()};return s.push(a),this.saveQueue(s),this.scheduleRetry(),a.id}blobToBase64Sync(e){return""}static blobToBase64(e){return new Promise((t,i)=>{let o=new FileReader;o.onload=()=>{let a=o.result.split(",")[1];t(a)},o.onerror=()=>i(new Error("Failed to convert blob to base64")),o.readAsDataURL(e)})}static base64ToBlob(e,t){let i=atob(e),o=new Uint8Array(i.length);for(let s=0;s<i.length;s++)o[s]=i.charCodeAt(s);return new Blob([o],{type:t})}removeFromQueue(e){let t=this.getQueue().filter(i=>i.id!==e);this.saveQueue(t)}scheduleRetry(){this.retryTimer&&clearTimeout(this.retryTimer);let e=this.getQueue();if(e.length===0)return;let t=Date.now(),i=Math.min(...e.map(s=>s.nextRetryAt)),o=Math.max(0,i-t);this.retryTimer=setTimeout(()=>{this.processQueue()},o)}async processQueue(){if(!this.isProcessing&&navigator.onLine){this.isProcessing=!0;try{let e=this.getQueue(),t=Date.now();for(let i of e)if(!(i.nextRetryAt>t)){if(i.retryCount>=ve){c.warn(`Max retries exceeded for submission ${i.id}, removing from queue`),this.removeFromQueue(i.id);continue}try{let o=await this.submitToApi(i);if(o.success)c.log(`Queued submission ${i.id} succeeded, feedback ID: ${o.feedbackId}`),this.removeFromQueue(i.id),window.dispatchEvent(new CustomEvent("ff:queue-submission-success",{detail:{id:i.id,feedbackId:o.feedbackId}}));else throw new Error(o.error||"Submission failed")}catch(o){c.warn(`Queue submission ${i.id} failed, scheduling retry`,o);let s=this.getQueue(),a=s.findIndex(p=>p.id===i.id);a!==-1&&(s[a].retryCount++,s[a].nextRetryAt=we(s[a].retryCount),this.saveQueue(s))}}}finally{this.isProcessing=!1,this.scheduleRetry()}}}async submitToApi(e){let t=new FormData;if(t.append("widgetKey",e.widgetKey),t.append("title",e.formData.title),t.append("description",e.formData.description),t.append("type",e.formData.type),t.append("metadata",JSON.stringify(e.formData.metadata)),e.formData.email&&t.append("email",e.formData.email),e.formData.name&&t.append("name",e.formData.name),e.screenshotDataUrl){let a=await(await fetch(e.screenshotDataUrl)).blob();t.append("screenshot",a,"screenshot.jpg")}if(e.recordingBlob&&e.recordingMimeType){let s=n.base64ToBlob(e.recordingBlob,e.recordingMimeType),a=e.recordingMimeType.includes("webm")?"webm":"mp4";t.append("recording",s,`recording.${a}`)}let i=await fetch(this.apiUrl,{method:"POST",body:t});if(!i.ok){let s=await i.text().catch(()=>"Unknown error");return{success:!1,error:`HTTP ${i.status}: ${s}`}}let o=await i.json();return{success:!0,feedbackId:o.feedbackId||o.id}}getQueueSize(){return this.getQueue().length}clearQueue(){this.saveQueue([]),this.retryTimer&&(clearTimeout(this.retryTimer),this.retryTimer=null)}destroy(){this.retryTimer&&(clearTimeout(this.retryTimer),this.retryTimer=null)}},D=null;function M(n){return D||(D=new w(n)),D}function X(n){let e="ff-submit-styles";if(document.getElementById(e))return;let t=`
    .ff-submit-overlay {
      position: fixed;
      top: 0;
      left: 0;
  ...
  `,i=document.createElement("style");i.id=e,i.textContent=t,document.head.appendChild(i)}function G(n,e){let t=r("div",{className:"ff-preview-thumbnail"});if(n){let i=r("img",{className:"ff-preview-img"});i.src=n.dataUrl,i.alt="Screenshot preview",t.appendChild(i),t.appendChild(r("span",{className:"ff-preview-label"},["Screenshot attached"]))}else if(e){let i=r("div",{className:"ff-preview-icon"},[l(d.video)]);t.appendChild(i);let o=Math.round(e.duration/1e3);t.appendChild(r("span",{className:"ff-preview-label"},[`Recording attached (${o}s)`]))}return t}var Ce=[{type:"bug",label:"Bug Report",icon:d.bug,color:"#E85D52"},{type:"feature",label:"Feature Request",icon:d.lightbulb,color:"#6B9AC4"}];function V(n,e){let t=r("div",{className:"ff-type-selector"});return Ce.forEach(i=>{let o=n===i.type,s=r("button",{className:`ff-type-option ${o?"ff-selected":""}`,type:"button","data-type":i.type},[r("div",{className:"ff-type-icon"},[l(i.icon)]),r("span",{className:"ff-type-label"},[i.label])]),a=s.querySelector(".ff-type-icon");a&&(a.style.color=i.color,o&&(a.style.backgroundColor=`${i.color}20`,a.style.borderColor=`${i.color}40`)),s.addEventListener("click",()=>e(i.type)),t.appendChild(s)}),t}function J(n,e){let t=r("div",{className:"ff-form-group"},[r("label",{className:"ff-form-label"},["Title"]),r("input",{className:"ff-submit-title-input ff-input",type:"text",placeholder:"Brief summary of the issue or request"})]),i=t.querySelector("input");return i.value=n,i.addEventListener("input",o=>{e(o.target.value)}),t}function Z(n,e){let t=r("div",{className:"ff-form-group"},[r("label",{className:"ff-form-label"},["Description"]),r("textarea",{className:"ff-submit-description-input ff-textarea",placeholder:"Provide more details about what happened or what you'd like to see..."})]),i=t.querySelector("textarea");return i.value=n,i.addEventListener("input",o=>{e(o.target.value)}),t}function ee(n,e,t,i){let o=r("div",{className:"ff-optional-section"}),s=r("div",{className:"ff-optional-header"},[r("span",{className:"ff-optional-label"},["Optional"])]);o.appendChild(s);let a=r("div",{className:"ff-form-group ff-form-group-sm"},[r("label",{className:"ff-form-label-sm"},[l(d.mail),"Email (for follow-up)"]),r("input",{className:"ff-input ff-input-sm",type:"email",placeholder:"your@email.com"})]),p=a.querySelector("input");p.value=n,p.addEventListener("input",g=>{t(g.target.value)}),o.appendChild(a);let h=r("div",{className:"ff-form-group ff-form-group-sm"},[r("label",{className:"ff-form-label-sm"},[l(d.user),"Name"]),r("input",{className:"ff-input ff-input-sm",type:"text",placeholder:"Your name"})]),f=h.querySelector("input");return f.value=e,f.addEventListener("input",g=>{i(g.target.value)}),o.appendChild(h),o}function te(n,e,t){let i=r("div",{className:"ff-consent-section"}),o=r("input",{type:"checkbox",className:"ff-consent-checkbox",id:"ff-privacy-consent"});o.checked=e,o.addEventListener("change",a=>{t(a.target.checked)});let s=r("label",{className:"ff-consent-label",for:"ff-privacy-consent"},[o,r("span",{className:"ff-consent-text"},["I acknowledge that my feedback may include personal information and agree to the ",r("a",{href:n,target:"_blank",className:"ff-consent-link"},["privacy policy"]),"."])]);return i.appendChild(s),i}function ie(){let n=r("div",{className:"ff-submit-loading"}),e=r("div",{className:"ff-spinner"},[l(d.spinner)]),t=r("p",{className:"ff-loading-text"},["Submitting your feedback..."]);return n.appendChild(e),n.appendChild(t),n}function oe(n,e,t){let i=r("div",{className:"ff-submit-success"}),o=r("div",{className:"ff-success-icon"},[l(d.check)]),s=r("h3",{className:"ff-success-title"},["Feedback Submitted!"]),a=r("p",{className:"ff-success-message"},["Thank you for your feedback. We'll review it shortly."]);if(e){let f=r("div",{className:"ff-success-warning"},[r("div",{className:"ff-warning-icon"},[l(d.warning||d.info)]),r("p",{className:"ff-warning-text"},[e])]);i.appendChild(o),i.appendChild(s),i.appendChild(f)}else i.appendChild(o),i.appendChild(s),i.appendChild(a);let p=r("div",{className:"ff-success-id"},[r("span",{className:"ff-id-label"},["Reference ID: "]),r("code",{className:"ff-id-value"},[n])]),h=H("Close","primary",t);return i.appendChild(p),i.appendChild(h),i}function re(n,e,t){let i=r("div",{className:"ff-submit-error"}),o=r("div",{className:"ff-error-icon"},[l(d.close)]),s=r("h3",{className:"ff-error-title"},["Submission Failed"]),a=r("p",{className:"ff-error-message"},[n||"Something went wrong. Your feedback has been saved and will be submitted automatically when the connection is restored."]),p=r("div",{className:"ff-error-actions"},[H("Try Again","secondary",e),H("Close","primary",t)]);return i.appendChild(o),i.appendChild(s),i.appendChild(a),i.appendChild(p),i}function H(n,e,t){let i=r("button",{className:`ff-submit-btn ff-btn-${e}`,type:"button"},[n]);return i.addEventListener("click",t),i}var b=class{constructor(e,t,i,o){this.container=null;this.state="form";this.formState={title:"",description:"",type:"bug",email:"",name:"",privacyConsent:!1};this.feedbackId="";this.errorMessage="";this.warningMessage="";this.config=e,this.callbacks=t,this.screenshot=i,this.recording=o,this.offlineQueue=M(e.apiUrl)}show(){X(this.config),this.render()}render(){this.container?.remove(),this.container=r("div",{className:"ff-submit-overlay"});let e=r("div",{className:"ff-submit-wrapper"});switch(this.state){case"form":e.appendChild(this.renderForm());break;case"loading":e.appendChild(ie());break;case"success":e.appendChild(oe(this.feedbackId,this.warningMessage,()=>{this.callbacks.onSuccess(this.feedbackId),this.destroy()}));break;case"error":e.appendChild(re(this.errorMessage,()=>{this.state="form",this.render()},()=>{this.callbacks.onError(this.errorMessage),this.destroy()}));break}this.container.appendChild(e),document.body.appendChild(this.container),this.state==="form"&&this.container.querySelector(".ff-submit-title-input")?.focus()}renderForm(){let e=r("div",{className:"ff-submit-form"}),t=r("div",{className:"ff-submit-header"},[r("h3",{className:"ff-submit-title"},["Submit Feedback"]),this.createCloseButton()]),i=r("div",{className:"ff-submit-content"});(this.screenshot||this.recording)&&i.appendChild(G(this.screenshot,this.recording)),i.appendChild(V(this.formState.type,s=>{this.formState.type=s,this.render()})),i.appendChild(J(this.formState.title,s=>{this.formState.title=s})),i.appendChild(Z(this.formState.description,s=>{this.formState.description=s})),i.appendChild(ee(this.formState.email,this.formState.name,s=>{this.formState.email=s},s=>{this.formState.name=s})),this.config.privacyPolicyUrl&&i.appendChild(te(this.config.privacyPolicyUrl,this.formState.privacyConsent,s=>{this.formState.privacyConsent=s}));let o=r("div",{className:"ff-submit-actions"},[this.createButton("Cancel","secondary",()=>this.cancel()),this.createButton("Submit Feedback","primary",()=>this.submit())]);return e.appendChild(t),e.appendChild(i),e.appendChild(o),e}createCloseButton(){let e=r("button",{className:"ff-submit-close",type:"button","aria-label":"Cancel"},[l(d.close)]);return e.addEventListener("click",()=>this.cancel()),e}createButton(e,t,i){let o=r("button",{className:`ff-submit-btn ff-btn-${t}`,type:"button"},[e]);return o.addEventListener("click",i),o}cancel(){this.destroy(),this.callbacks.onCancel()}async submit(){if(!this.formState.title.trim()){alert("Please enter a title for your feedback.");return}if(this.config.privacyPolicyUrl&&!this.formState.privacyConsent){alert("Please acknowledge the privacy policy to submit feedback.");return}this.state="loading",this.render();try{let e=await this.submitFeedback();if(e.success&&e.feedbackId)this.feedbackId=e.feedbackId,this.warningMessage=e.warning||"",this.state="success",this.render();else throw new Error(e.error||"Submission failed")}catch(e){c.error("Submission failed",e),await this.queueForRetry(),this.errorMessage=e instanceof Error?e.message:"Submission failed",this.state="error",this.render()}}async submitFeedback(){let e=this.getMetadata(),t=this.config.apiUrl||"https://feedbackflow.cc/api/widget/submit",i=new FormData;if(i.append("widgetKey",this.config.widgetKey),i.append("title",this.formState.title),i.append("description",this.formState.description),i.append("type",this.formState.type),i.append("metadata",JSON.stringify(e)),this.formState.email&&i.append("email",this.formState.email),this.formState.name&&i.append("name",this.formState.name),this.screenshot?.blob&&i.append("screenshot",this.screenshot.blob,"screenshot.jpg"),this.recording?.blob){let a=this.recording.mimeType.includes("webm")?"webm":"mp4";i.append("recording",this.recording.blob,`recording.${a}`),i.append("recordingDuration",(this.recording.duration/1e3).toString())}let o=await fetch(t,{method:"POST",body:i});if(!o.ok){let a=await o.text().catch(()=>"Unknown error");throw new Error(`HTTP ${o.status}: ${a}`)}let s=await o.json();return{success:!0,feedbackId:s.feedbackId||s.id,warning:s.warning}}async queueForRetry(){let e=this.getMetadata(),t={title:this.formState.title,description:this.formState.description,type:this.formState.type,email:this.formState.email||void 0,name:this.formState.name||void 0,metadata:e},i;this.recording?.blob&&(i=await w.blobToBase64(this.recording.blob));let o=this.offlineQueue.getQueue(),s={id:`ff_${Date.now()}_${Math.random().toString(36).substring(2,9)}`,widgetKey:this.config.widgetKey,formData:t,screenshotDataUrl:this.screenshot?.dataUrl,recordingBlob:i,recordingMimeType:this.recording?.mimeType,timestamp:Date.now(),retryCount:0,nextRetryAt:Date.now()};o.push(s),localStorage.setItem("ff_submission_queue",JSON.stringify(o)),c.log("Feedback queued for retry")}getMetadata(){return{url:window.location.href,userAgent:navigator.userAgent,timestamp:new Date().toISOString(),screenWidth:window.screen.width,screenHeight:window.screen.height}}destroy(){this.container?.remove(),this.container=null}};var I=class{constructor(e,t,i){this.config=e;this.onOpen=t;this.onMinimize=i;this.buttonContainer=null;this.triggerButton=null;this.minimizeButton=null}create(){return this.buttonContainer=r("div",{className:"ff-button-container"}),this.minimizeButton=r("button",{className:"ff-minimize-button","aria-label":"Minimize feedback widget",type:"button",title:"Hide feedback button (click any corner to show again)"},[l(d.close)]),this.triggerButton=r("button",{className:"ff-trigger-button","aria-label":"Open feedback widget",type:"button"},[l(d.feedback),this.config.buttonText,this.minimizeButton]),this.buttonContainer.appendChild(this.triggerButton),this.buttonContainer}setupEventListeners(){this.triggerButton?.addEventListener("click",()=>{this.onOpen()}),this.minimizeButton?.addEventListener("click",e=>{e.stopPropagation(),this.onMinimize()})}getElement(){return this.buttonContainer}getTriggerButton(){return this.triggerButton}};var R=class{constructor(e){this.onRestore=e;this.indicators=[]}create(){let e=["top-left","top-right","bottom-left","bottom-right"];return this.indicators=e.map(t=>r("div",{className:`ff-corner-indicator ff-corner-${t}`,"aria-label":"Show feedback widget",role:"button",tabindex:"0"})),this.indicators}setupEventListeners(){this.indicators.forEach(e=>{e.addEventListener("click",()=>{this.onRestore()}),e.addEventListener("keydown",t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.onRestore())})})}getElements(){return this.indicators}};var L=class{constructor(e,t,i){this.config=e;this.onClose=t;this.onCaptureStart=i;this.modalOverlay=null}create(){this.modalOverlay=r("div",{className:"ff-modal-overlay",role:"dialog","aria-modal":"true","aria-labelledby":"ff-modal-title"});let e=r("div",{className:"ff-modal"}),t=this.createHeader(),i=r("div",{className:"ff-modal-content"},[this.createCaptureOptions()]),o=this.createFooter();return e.appendChild(t),e.appendChild(i),e.appendChild(o),this.modalOverlay.appendChild(e),this.modalOverlay}createHeader(){let e=r("button",{className:"ff-close-button","aria-label":"Close feedback widget",type:"button"},[l(d.close)]);return r("div",{className:"ff-modal-header"},[r("h2",{className:"ff-modal-title",id:"ff-modal-title"},["Share Feedback"]),e])}createCaptureOptions(){let e=r("div",{className:"ff-capture-options"}),t=u(),i=k()&&!t,o=t?"Take a photo or select from gallery":"Capture and annotate your screen",s=r("button",{className:"ff-capture-option","data-capture-type":"screenshot",type:"button"},[r("div",{className:"ff-capture-icon ff-screenshot"},[l(d.camera)]),r("div",{className:"ff-capture-text"},[r("p",{className:"ff-capture-title"},[t?"Add a Photo":"Take a Screenshot"]),r("p",{className:"ff-capture-description"},[o])])]),a=i?"ff-capture-option":"ff-capture-option ff-capture-option-disabled",p=i?"Record with voice narration (up to 2 min)":"Desktop only",h=r("button",{className:a,"data-capture-type":"record",type:"button"},[r("div",{className:"ff-capture-icon ff-record"},[l(d.video)]),r("div",{className:"ff-capture-text"},[r("p",{className:"ff-capture-title"},["Record Your Screen"]),r("p",{className:"ff-capture-description"},[p])])]);return e.appendChild(s),e.appendChild(h),e}createFooter(){let e=["Powered by ",r("a",{href:"https://feedbackflow.cc",target:"_blank"},["FeedbackFlow"])];return this.config.privacyPolicyUrl&&e.push(" · ",r("a",{href:this.config.privacyPolicyUrl,target:"_blank"},["Privacy Policy"])),r("div",{className:"ff-modal-footer"},[r("div",{className:"ff-powered-by"},e)])}setupEventListeners(){this.modalOverlay?.querySelector(".ff-close-button")?.addEventListener("click",()=>{this.onClose()}),this.modalOverlay?.addEventListener("click",e=>{e.target===this.modalOverlay&&this.onClose()}),this.modalOverlay?.querySelectorAll(".ff-capture-option").forEach(e=>{e.addEventListener("click",()=>{let t=e.getAttribute("data-capture-type");t&&this.onCaptureStart(t)})})}getElement(){return this.modalOverlay}show(){this.modalOverlay?.classList.add("ff-visible")}hide(){this.modalOverlay?.classList.remove("ff-visible")}};var P=class{constructor(e,t,i,o){this.config=e;this.buttonContainer=t;this.isMinimized=i;this.isModalOpen=o;this.hoverTimeout=null;this.hoverZoneSize=150}setup(){document.addEventListener("mousemove",e=>{this.handleMouseMove(e)})}handleMouseMove(e){if(this.isMinimized()||this.isModalOpen()||!this.buttonContainer)return;let t=this.config.position.includes("bottom"),o=this.config.position.includes("right")?window.innerWidth-e.clientX:e.clientX,s=t?window.innerHeight-e.clientY:e.clientY;o<this.hoverZoneSize&&s<this.hoverZoneSize?this.showButton():this.hideButton()}showButton(){this.hoverTimeout&&(clearTimeout(this.hoverTimeout),this.hoverTimeout=null),this.buttonContainer?.classList.add("ff-hover-peek")}hideButton(){this.hoverTimeout||(this.hoverTimeout=window.setTimeout(()=>{this.buttonContainer?.classList.remove("ff-hover-peek"),this.hoverTimeout=null},300))}destroy(){this.hoverTimeout&&(clearTimeout(this.hoverTimeout),this.hoverTimeout=null)}};var N=class{constructor(e,t){this.buttonContainer=e;this.cornerIndicators=t;this.isMinimized=!1;this.STORAGE_KEY="ff-widget-minimized";this.isMinimized=localStorage.getItem(this.STORAGE_KEY)==="true"}getIsMinimized(){return this.isMinimized}minimize(){this.isMinimized=!0,localStorage.setItem(this.STORAGE_KEY,"true"),this.applyMinimizedState()}restore(){this.isMinimized=!1,localStorage.setItem(this.STORAGE_KEY,"false"),this.applyRestoredState()}applyMinimizedState(){this.buttonContainer&&this.buttonContainer.classList.add("ff-minimized"),this.cornerIndicators.forEach(e=>{e.classList.add("ff-visible")})}applyRestoredState(){this.buttonContainer&&this.buttonContainer.classList.remove("ff-minimized"),this.cornerIndicators.forEach(e=>{e.classList.remove("ff-visible")})}applyInitialState(){this.isMinimized&&this.applyMinimizedState()}};var v=class{constructor(e){this.root=null;this.hoverDetection=null;this.stateManager=null;this.screenshotUI=null;this.recordUI=null;this.submitUI=null;this.capturedScreenshot=null;this.capturedRecording=null;this.config={...z,...e},this.state={isOpen:!1,isCapturing:!1,captureMode:null},this.triggerButton=new I(this.config,()=>this.open(),()=>this.minimize()),this.cornerIndicators=new R(()=>this.restore()),this.modal=new L(this.config,()=>this.close(),t=>this.startCapture(t)),this.init()}init(){A($(this.config),"ff-widget-styles"),this.root=O();let e=this.triggerButton.create();this.root.appendChild(e),this.cornerIndicators.create().forEach(o=>this.root?.appendChild(o));let i=this.modal.create();this.root.appendChild(i),this.stateManager=new N(this.triggerButton.getElement(),this.cornerIndicators.getElements()),this.hoverDetection=new P(this.config,this.triggerButton.getElement(),()=>this.stateManager?.getIsMinimized()??!1,()=>this.state.isOpen),this.setupEventListeners(),this.stateManager.applyInitialState(),M(this.config.apiUrl)}setupEventListeners(){this.triggerButton.setupEventListeners(),this.cornerIndicators.setupEventListeners(),this.modal.setupEventListeners(),this.hoverDetection?.setup(),document.addEventListener("keydown",e=>{e.key==="Escape"&&this.state.isOpen&&this.close()}),window.addEventListener("ff:switch-to-screenshot",()=>{this.startCapture("screenshot")})}open(){if(this.state.isOpen)return;this.state.isOpen=!0,this.modal.show(),this.triggerButton.getTriggerButton()?.setAttribute("aria-expanded","true"),this.modal.getElement()?.querySelector("button, [href], input, select, textarea")?.focus()}close(){this.state.isOpen&&(this.state.isOpen=!1,this.modal.hide(),this.triggerButton.getTriggerButton()?.setAttribute("aria-expanded","false"),this.triggerButton.getTriggerButton()?.focus())}minimize(){this.stateManager?.minimize()}restore(){this.stateManager?.restore()}startCapture(e){this.state.captureMode=e,this.state.isCapturing=!0,this.close();let t=new CustomEvent("ff:capture-start",{detail:{mode:e,widgetKey:this.config.widgetKey}});window.dispatchEvent(t),e==="screenshot"?this.startScreenshotCapture():e==="record"&&this.startRecordingCapture()}startScreenshotCapture(){this.screenshotUI=new E(this.config,{onConfirm:e=>{this.handleScreenshotConfirm(e)},onCancel:()=>{this.handleScreenshotCancel()}}),this.screenshotUI.start()}handleScreenshotConfirm(e){this.capturedScreenshot=e,this.state.isCapturing=!1;let t=new CustomEvent("ff:screenshot-captured",{detail:{widgetKey:this.config.widgetKey,screenshot:e}});window.dispatchEvent(t),c.log("Screenshot captured",{width:e.width,height:e.height,size:e.blob?`${(e.blob.size/1024).toFixed(2)}KB`:"unknown"}),this.screenshotUI?.destroy(),this.screenshotUI=null,this.showSubmitForm()}handleScreenshotCancel(){this.state.isCapturing=!1,this.state.captureMode=null,this.capturedScreenshot=null,this.screenshotUI?.destroy(),this.screenshotUI=null}startRecordingCapture(){this.recordUI=new T(this.config,{onConfirm:e=>{this.handleRecordingConfirm(e)},onCancel:()=>{this.handleRecordingCancel()}}),this.recordUI.start()}handleRecordingConfirm(e){this.capturedRecording=e,this.state.isCapturing=!1;let t=new CustomEvent("ff:recording-captured",{detail:{widgetKey:this.config.widgetKey,recording:{duration:e.duration,mimeType:e.mimeType,size:e.blob.size}}});window.dispatchEvent(t),c.log("Recording captured",{duration:`${(e.duration/1e3).toFixed(1)}s`,size:`${(e.blob.size/(1024*1024)).toFixed(2)}MB`,mimeType:e.mimeType}),this.recordUI?.destroy(),this.recordUI=null,this.showSubmitForm()}handleRecordingCancel(){this.state.isCapturing=!1,this.state.captureMode=null,this.capturedRecording=null,this.recordUI?.destroy(),this.recordUI=null}showSubmitForm(){this.submitUI=new b(this.config,{onSuccess:e=>{this.handleSubmissionSuccess(e)},onCancel:()=>{this.handleSubmissionCancel()},onError:e=>{this.handleSubmissionError(e)}},this.capturedScreenshot,this.capturedRecording),this.submitUI.show()}handleSubmissionSuccess(e){let t=new CustomEvent("ff:submission-success",{detail:{widgetKey:this.config.widgetKey,feedbackId:e}});window.dispatchEvent(t),c.log("Feedback submitted successfully",{feedbackId:e}),this.cleanupAfterSubmission()}handleSubmissionCancel(){c.log("Submission cancelled"),this.cleanupAfterSubmission()}handleSubmissionError(e){let t=new CustomEvent("ff:submission-error",{detail:{widgetKey:this.config.widgetKey,error:e}});window.dispatchEvent(t),c.warn("Submission error",{error:e}),this.cleanupAfterSubmission()}cleanupAfterSubmission(){this.submitUI?.destroy(),this.submitUI=null,this.capturedScreenshot=null,this.capturedRecording=null,this.state.captureMode=null}getCapturedScreenshot(){return this.capturedScreenshot}getCapturedRecording(){return this.capturedRecording}getConfig(){return{...this.config}}getState(){return{...this.state}}destroy(){this.screenshotUI?.destroy(),this.screenshotUI=null,this.recordUI?.destroy(),this.recordUI=null,this.submitUI?.destroy(),this.submitUI=null,this.hoverDetection?.destroy(),this.hoverDetection=null,this.root?.remove(),document.getElementById("ff-widget-styles")?.remove(),document.getElementById("ff-screenshot-styles")?.remove(),document.getElementById("ff-recording-styles")?.remove(),document.getElementById("ff-submit-styles")?.remove()}};var m=null;function ke(){let n=document.querySelectorAll("script[data-widget-key]"),e=n[n.length-1];if(!e)return c.error("No script tag with data-widget-key found"),null;let t=e.dataset.widgetKey;if(!t)return c.error("data-widget-key is required"),null;let i={widgetKey:t},o=e.dataset.position;return o&&["bottom-right","bottom-left","top-right","top-left"].includes(o)&&(i.position=o),e.dataset.primaryColor&&(i.primaryColor=e.dataset.primaryColor),e.dataset.backgroundColor&&(i.backgroundColor=e.dataset.backgroundColor),e.dataset.textColor&&(i.textColor=e.dataset.textColor),e.dataset.buttonText&&(i.buttonText=e.dataset.buttonText),e.dataset.apiUrl&&(i.apiUrl=e.dataset.apiUrl),e.dataset.privacyPolicyUrl&&(i.privacyPolicyUrl=e.dataset.privacyPolicyUrl),i}function ne(){if(m){c.warn("Widget already initialized");return}let n=ke();if(!(!n||!n.widgetKey))try{m=new v(n),c.log("Widget initialized")}catch(e){c.error("Failed to initialize widget",e)}}var se={init(n){if(m){c.warn("Widget already initialized");return}try{m=new v(n)}catch(e){c.error("Failed to initialize widget",e)}},open(){m?.open()},close(){m?.close()},getInstance(){return m},destroy(){m?.destroy(),m=null}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ne):ne();typeof window<"u"&&(window.FeedbackFlow=se);return fe(Ee);})();
